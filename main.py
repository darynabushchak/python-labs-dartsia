...
chair_list.add_chair(
    OfficeChair({"pink"}, 3, "wood", 140, "bilka 1", "vata", 35, 80, 50)
)
chair_list.add_chair(
    OfficeChair({"black"}, 4, "plastic", 150, "bilka 2", "pinoplast", 50, 100, 30)
)
chair_list.add_chair(FeedingTable({"milky"}, 5, "wood", 50, "bilka 3", 145, 100))
...
chair_list.add_chair(RockingChair({"gray"}, 8, "plastic", 200, "bilka 6", 52, 120, 95))
chair_list.add_chair(DentalChair({"blue"}, 9, "wood", 200, "bilka 7", 140, 90, 115))
chair_list.add_chair(DentalChair({"green"}, 10, "plastic", 150, "bilka 8", 130, 95, 110))
